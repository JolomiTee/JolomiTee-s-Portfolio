...
const Sidebar = () => {
    ...
    return (
        // <aside className={`sidebar mb-4 overflow-hidden transition-2 max-h-[112px] md:max-h-[112px] lg:max-h-[180px] lg:min-w-[1024px] ${navOpen ? 'max-h-[660px]' : ''} md:mb-[20px]`}></aside>

        <aside
            className={`sidebar mb-4 overflow-hidden transition-2 md:mb-[20px] ${navOpen ? 'max-h-[660px]' : 'max-h-[112px]'} `}>

            <div className="sidebar-info relative flex justify-start items-center gap-[15px] md:gap-[25px]">

                <figure className="avatar-box bg-gradient-onyx rounded-2xl">
                    <img src={ProfilePhoto} alt="Jolomi Taiwo" width="80" className='rounded-2xl md:w-[100px]' />
                </figure>
