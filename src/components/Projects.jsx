            ...
            <ul className="project-list flex justify-center flex-wrap gap-8 mb-3">
                {
                    projectList.map((project, index) => (
                        ...
                        <li key={index} class="project-item block">

                            <a className='w-full' target="_blank" href={project.link}>

                                <figure class="project-img relative w-full h-[200px] rounded-2xl overflow-hidden mb-4 before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-opacity-0 z-[1] transition-1">

                                    <div class="project-item-icon-box scale-.75 bg-jet text-orange-yellow-crayola absolute top-[35%] left-[40%] text-[20px] p-5 rounded-xl opacity-0 z-[1] transition-1">
                                ...
                                <h3 class="project-title ml-3 mb-2 text-white-1 text-fs-4 font-fw-400 capitalize leading-[1.3]">
                                    {project.name}
                                </h3>
